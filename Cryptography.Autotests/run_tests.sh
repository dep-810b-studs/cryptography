...
chmod +x ./$APP_UNDER_TEST_BINARIES_DIR/$APP_UNDER_TEST_NAME.dll
sudo python3 ./demontraiting_app_tests.py ./$APP_UNDER_TEST_BINARIES_DIR/$APP_UNDER_TEST_NAME.dll
