...
public class GaloisField
{
    ...
    {
        if (b == BinaryPolynomial.Zero) return (a, 1, 0);
    ...
    /// <returns></returns>
    private byte MultiplicativeInverseUsingExponentiation(byte number)
    {
        return Pow(number, 254);
    }
    ...
    {
        return BinaryPolynomial.ToPotentialForm(number, 8);
    }
}